...
public class Const {
    ...
    public static final UUID  UUID_SERVICE_INFO                 = UUID.fromString("0000180a-0000-1000-8000-00805f9b34fb");
    public static final UUID       UUID_CHARACTER_BLUETOOTH_VER = UUID.fromString("00002a27-0000-1000-8000-00805f9b34fb");
